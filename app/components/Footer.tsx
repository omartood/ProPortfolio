      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mt-4 max-w-md">
              ...
              and applications with a focus on user experience and performance.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm text-center md:text-left">
            &copy; {currentYear} Omar Jibril Abdulkadir. All rights reserved.
          </p>
          ...
          >
            <Link
              href="#hero"
              className="bg-primary/10 hover:bg-primary/20 text-primary p-3 rounded-full transition-colors duration-300 inline-flex"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
